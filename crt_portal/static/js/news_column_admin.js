...
(function() {
  ...
  function initEditor(editor) {
    var textarea = editor.querySelector('[data-news-column-json]');
    var rowsContainer = editor.querySelector('[data-news-column-rows]');
    var addButton = editor.querySelector('[data-news-column-add]');
    var toggleButton = editor.querySelector('[data-news-column-toggle-raw]');
    ...
    function buildRow(article, index) {
      ...
      row.className = 'news-column-editor__row';

      var dateInput = document.createElement('input');
      dateInput.type = 'date';
      dateInput.className = 'news-column-editor__date';
      ...
      titleInput.className = 'news-column-editor__title';
      ...
      linkInput.type = 'url';
      linkInput.className = 'news-column-editor__link';
      ...
      buttons.className = 'news-column-editor__row-buttons';

      var upButton = makeButton('\u2191', 'button news-column-editor__move');
      ...
      var downButton = makeButton('\u2193', 'button news-column-editor__move');
      ...
      var removeButton = makeButton('Remove', 'button news-column-editor__remove');
  ...
  function showRawFallback(editor, textarea, rowsContainer, addButton, toggleButton) {
    ...
    note.className = 'news-column-editor__error';
    note.textContent =
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var editors = document.querySelectorAll('[data-news-column-editor]');
