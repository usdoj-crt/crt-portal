(function(root) {
    ...
    function downloadAttachment(e) {
        ...
        .then(function(response) {
            ...
            responseWrapper.innerHTML = response.status == 404 ? `<div class="usa-alert__body"><em class="usa-alert__text">File not found</em></div>` : '';
    ...
    function removeAttachment(attachmentId) {
        ...
        .then(function(data) {
            ...
            responseWrapper.innerHTML = data.type == 'error' ? `<div class="usa-alert__body"><em class="usa-alert__text">${data.response}</em></div>` : '';
