(function(root, dom) {
  ...
  function filterController() {
    ...
    const locationName1El = root.CRT.formEl.querySelectorAll('input[name="location_name_1"]');
    const locationName2El = root.CRT.formEl.querySelectorAll('input[name="location_name_2"]');
