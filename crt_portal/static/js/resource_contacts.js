(function(root) {
    ...
    function createRow(data) {
      ...
      newRow.innerHTML = `
              ...
              <td>
                  <button data-contact-id="${data.id}" data-contact-name="${data.first_name}" class="usa-button usa-button--outline remove-contact-button">
                  <img data-contact-id="${data.id}" src="/static/img/trash-2.svg" alt="remove contact" class="icon"></button>
              </td>
              `;
