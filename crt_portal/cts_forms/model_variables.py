...
PROTECTED_CLASS_FIELDS = [
    ...
    (5, 'Gun ownership', _('Gun Ownership')),
    (6, 'Immigration', _('Immigration/citizenship status (choosing this will not share your status)')),
    (7, 'Language', _('Language')),
    (8, 'National origin', _('National origin (including ancestry and ethnicity)')),
    (9, 'Pregnancy', _('Pregnancy')),
    (10, 'Race/color', _('Race/color')),
    (11, 'Religion', _('Religion')),
    (12, 'Sex', _('Sex')),
    (13, 'Orientation', _('Sexual orientation')),
    (14, 'None', _('None of these apply to me')),
    (15, 'Other', _('Other reason')),
]
...
BATCH_VERIFIED_STATUS = 'verified'
