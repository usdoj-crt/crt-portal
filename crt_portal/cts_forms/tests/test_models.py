...
class ReportTests(TestCase):
    ...
    def test_report_disposes(self):
        ...
        cases = [
            ...
            ('contact_2_first_name', 'Bob', None),
            ('contact_2_last_name', 'Smith', None),
            ...
            ('contact_2_zip', '12345', None),
            ('contact_2_inmate_number', '12345', None),

            ('contact_3_first_name', 'Bob', None),
            ('contact_3_last_name', 'Smith', None),
            ...
            ('contact_3_zip', '12345', None),
            ('contact_3_inmate_number', '12345', None),

            ('contact_4_first_name', 'Bob', None),
            ('contact_4_last_name', 'Smith', None),
