...
from .views import (ActionsView, FormLetterView, index_view, dashboard_view, ShowView, ProFormView,
...
urlpatterns = [
    ...
    path('form-letters/', FormLetterView.as_view(template_name="form_letters.html"), name='form_letters.html')
]
