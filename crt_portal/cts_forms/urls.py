...
from .views import (ActionsView, SavedSearchActionView, SavedSearchView, data_piecemeal_view, new_user_landing_view, index_view, data_view, dashboard_view, dashboard_activity_log_view, disposition_view, RoutingGuideView, DispositionGuideView, DispositionActionsView, DispositionBatchActionsView, ShowView, ProFormView,
                    ...
                    PrintView, ProfileView, ReportAttachmentView, ReportDataView, DataExport, RemoveReportAttachmentView, unsubscribe_view, notification_view, phone_pro_form_view, test_site_view, resources_view, ResourceActionView, llm_chat_view, llm_summarize_report_view, llm_summarize_reports_view)
...
urlpatterns = [
    ...
    path('data/<str:notebook_urls>/', data_piecemeal_view, name='data-piecemeal'),
    ...
    path('llm/summarize-reports/', llm_summarize_reports_view, name='llm-summarize-reports'),
]
