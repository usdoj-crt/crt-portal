...
urlpatterns = [
    ...
    path('new/phone/', phone_pro_form_view, name='crt-phone-pro-form', kwargs={'section': 'VOT'}),  # Legacy url for the vot-specific form
    ...
    path('new/pro/<str:section>/', phone_pro_form_view, name='crt-phone-pro-form'),
    path('new/pro/<str:section>/<int:report_id>/', phone_pro_form_view, name='crt-phone-pro-form'),
