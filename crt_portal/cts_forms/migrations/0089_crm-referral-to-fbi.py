# Generated by Django 2.2.13 on 2020-08-28 18:44
...
def remove_template(apps, schema_editor):
    ResponseTemplate = apps.get_model('cts_forms', 'ResponseTemplate')
    ResponseTemplate.objects.get(title='CRM - Referral to FBI').delete()


class Migration(migrations.Migration):

    dependencies = [
        ('cts_forms', '0088_standardize_form_letter_subjects'),
    ]
