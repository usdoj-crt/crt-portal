...
귀하의 {{ ko.date_of_intake }} 서신에 감사드립니다. 귀하의 신고 번호는 {{ record_locator }} 입니다. 특별소송과 [Special Litigation Section]는 민권 침해를 식별하기 위해 지역 사회 구성원들의 정보에 의존합니다. 매 주 저희는 수 백 건의 잠재적 침해에 대한 신고를
...
경우, 개인 변호사, 비영리 또는 법률 구조 단체에 도움을 요청 할 수도 있습니다. 저희가 개인 또는 단일 사건을 해결할 수 있는 분야는 두가지 뿐 입니다: 1) 주립 또는 지방 정부가 운영하거나 이를 위해 운영되는 교도소, 감옥, 정신 병원 또는 기타 시설에서 귀하의 종교생활을 금지 시키는 경우 저희는 귀하를 도울 수 있습니다; 2) 귀하가 생식 건강 관리 시설 또는 종교 기관에 출입 할 때 무력 또는 무력의 위협을 경험 한 경우 저희는 귀하를 도울 수 있습니다.
 ...
 특별소송과(Special Litigation Section) 또는 저희가 하는 일에 대한 자세한
정보는 저희 웹 페이지를 참고하십시오: www.justice.gov/crt/about/spl/.

감사드립니다.

미국 법무부(U.S. Department of Justice)
민권국(Civil Rights Division)
""")


def remove_letters(apps, schema_editor):
    ResponseTemplate = apps.get_model('cts_forms', 'ResponseTemplate')
    ResponseTemplate.objects.filter(title='SPL - Standard Form Letter (Korean)').delete()


class Migration(migrations.Migration):

    dependencies = [
        ('cts_forms', '0119_create_spl_vietnamese'),
    ]
