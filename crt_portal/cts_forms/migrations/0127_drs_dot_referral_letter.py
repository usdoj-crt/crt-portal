...
def add_drs_dot_referral_letter(apps, schema_editor):
    ...
    ResponseTemplate.objects.create(
        title='DRS - DOT Referral Form Letter',
        subject=subject,
        body="""
{{ addressee }},
...
def remove_drs_dot_referral_letter(apps, schema_editor):
    ResponseTemplate = apps.get_model('cts_forms', 'ResponseTemplate')
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_drs_dot_referral_letter, remove_drs_dot_referral_letter)
    ]
